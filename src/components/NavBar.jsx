            ...
            <div className='navBarMobileContainer__logoContainer'>
                {
                    ...
                    <a className='navBarMobileContainer__logoContainer__logo' href="/home">
                        <img src="/img/logoMBsolucionesinformaticasNegro.png" className='navBarMobileContainer__logoContainer__logo__prop' alt="logo-que-corte"/>
                    </a>
                    :
                    <a className='navBarMobileContainer__logoContainer__logo' href="/home">
                        <img src="/img/logoMBsolucionesinformaticasNegro.png" className='navBarMobileContainer__logoContainer__logo__prop' alt="logo-que-corte"/>
        ...
        <div className='navBarContainer'>
            <div className='navBarContainer__hMenuLogo'>
                ...
                <div className='navBarContainer__hMenuLogo__logo'>
                    <img src="/img/logoMBsolucionesinformaticasNegro.png" className='navBarContainer__hMenuLogo__logo__prop' alt="logo-que-corte"/>
                </div>
            </div>
