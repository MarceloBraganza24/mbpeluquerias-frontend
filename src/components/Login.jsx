            ...
            <div className='loginContainer'>
                ...
                <div className='loginContainer__credentialsContainer'>
                    ...
                    <div className='loginContainer__credentialsContainer__credentials'>
                        ...
                        <div className='loginContainer__credentialsContainer__credentials__phrase'>
                            <h1 className='loginContainer__credentialsContainer__credentials__phrase__titleDown'>Peluquerías</h1>
                        </div>
                        <div className='loginContainer__credentialsContainer__credentials__phrase'>
                ...
                <div className='loginContainer__logo'>
                    <img src="/img/logoMBsolucionesinformaticasNegro.png" className='loginContainer__logo__prop' alt="logo-que-corte"/>
                ...
                <div className='loginContainer__background-img-up'>
                    <img src="/img/logoMBsolucionesinformaticasNegro.png" className='loginContainer__background-img-up__prop' alt="logo-que-corte"/>
                </div>
                ...
                <div className='loginContainer__credentials'>
                    ...
                    <div className='loginContainer__credentials__phrase'>
                        <h1 className='loginContainer__credentials__phrase__titleDown'>Peluquerías</h1>
                    </div>
                    <div className='loginContainer__credentials__phrase'>
