                                ...
                                <div className='partnersContainerIsLoggedIn__payMembershipFeeContainer__labels-btn__btn'>
                                    {
                                            ...
                                            !deleteTicketModal?
                                                <>
                                                    <button id='btnPayMembershipFee' style={{width:'250px',backgroundColor:'#04064e'}} className='partnersContainerIsLoggedIn__payMembershipFeeContainer__labels-btn__btn__prop'>Aún no puedes pagar la cuota</button>
                                                </>
                                                :
                                                <button id='btnPayMembershipFee' style={{width:'250px',backgroundColor:'#04064e'}} className='partnersContainerIsLoggedIn__payMembershipFeeContainer__labels-btn__btn__prop'>Aún no puedes pagar la cuota</button>
